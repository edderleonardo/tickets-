...
from tickets.apps.cars.api.serializers import CarDetailSerializer
from tickets.apps.cars.api.serializers import OwnerCarsSerializer
...
@extend_schema_view(
    ...
    by_owner=extend_schema(
        summary="Listar vehículos por dueño",
        description="Devuelve una lista de vehículos pertenecientes a un propietario específico.",
    ),
)
